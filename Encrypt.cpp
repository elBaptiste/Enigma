...
#include "Encrypt.h"
std::string Encrypt::encod(std::string message, std::string clef1,  std::string clef2,  std::string clef3) {
    return "rien";
};
#include <fstream>
#include <iostream>
...
std::string Encrypt::decod(std::string message, std::string clef1, std::string clef2, std::string clef3) {
    return "rien";
};